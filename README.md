...
- **Vitalwerte-Verlauf** — Zeitreihe je Metrik (Schritte, Energie, Puls, Ruhepuls, HRV, Gewicht, VO2max, Blutsauerstoff, Geh-/Laufstrecke, Gehgeschwindigkeit, Schwimmdistanz, …) mit gleitender Ø-Linie. Messlücken (Werte unter 20 % des Medians, etwa durch den angebrochenen heutigen Tag oder eine nicht getragene Uhr) fließen nicht in Ø, Min und Max ein und werden unter dem Diagramm ausgewiesen.
